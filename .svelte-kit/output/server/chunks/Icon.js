...
<path d="M37.5 62C44.4036 62 50 56.4036 50 49.5C50 42.5964 44.4036 37 37.5 37C30.5964 37 25 42.5964 25 49.5C25 56.4036 30.5964 62 37.5 62Z" stroke="currentColor" stroke-width="10"/>`
  ...
  return `<svg${add_attribute("style", `width:${size};height:${size};`, 0)} viewBox="${"0 0 " + escape(100, true) + " " + escape(100, true)}" fill="none" stroke="var(--text)" class="svelte-19r36i"><!-- HTML_TAG_START -->${displayIcon?.svg ?? icons[0].svg}<!-- HTML_TAG_END --></svg>`;
});
export {
  Icon as I
};
