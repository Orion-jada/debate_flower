...
import { B as Button, b as isChangelogVersionCurrent, d as connections, s as settings, n as nodes, e as pendingAction, f as focusId, g as activeMouse, h as history, j as checkIdBox, k as getAdjacentBox, l as addNewBox, t as toggleBoxFormat, m as addNewExtension, o as tick, q as deleteBox, u as getNode, v as addNewEmpty, w as selectedFlowId, x as lastFocusIds, y as settingsGroups, T as TutorialHighlight, z as tutorialStep, A as Tooltip, M as MAX_SAVED_FLOWS, C as savedNodesDatas, D as sideDocText, E as currentCloudFlowId, F as currentUser, G as flowPresence, H as listFlowShares, i as isLoggedIn, I as saveStatus, J as cloudFlowList, K as authLoading, L as openPopup, N as addNewFlow, O as deleteFlow } from "../../../chunks/autoSave.js";
...
const css$1 = {
  code: ".share-flow.svelte-fny6i0.svelte-fny6i0{display:flex;flex-direction:column;gap:1.25rem;padding:0.5rem;min-width:360px}h3.svelte-fny6i0.svelte-fny6i0{margin:0;font-size:1.2rem}.section-title.svelte-fny6i0.svelte-fny6i0{font-size:0.8rem;text-transform:uppercase;letter-spacing:0.04em;opacity:0.55;font-weight:var(--font-weight-bold);margin-bottom:0.4rem}.warning.svelte-fny6i0.svelte-fny6i0{margin:0;color:hsl(40, 80%, 55%);font-size:0.85rem}.presence-section.svelte-fny6i0.svelte-fny6i0{background:var(--background-accent-indent);border-radius:calc(var(--border-radius) * 0.5);padding:0.75rem}.presence-label.svelte-fny6i0.svelte-fny6i0{font-size:0.7rem;text-transform:uppercase;letter-spacing:0.04em;opacity:0.5;margin-bottom:0.4rem}.presence-avatars.svelte-fny6i0.svelte-fny6i0{display:flex;align-items:center;gap:0.35rem;flex-wrap:wrap}.presence-avatar.svelte-fny6i0.svelte-fny6i0{width:28px;height:28px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:0.65rem;font-weight:bold;color:white;flex-shrink:0}.presence-names.svelte-fny6i0.svelte-fny6i0{margin-left:0.35rem;font-size:0.8rem}.presence-name.svelte-fny6i0.svelte-fny6i0{font-weight:var(--font-weight-bold)}.email-form.svelte-fny6i0.svelte-fny6i0{display:flex;gap:0.4rem}.email-form.svelte-fny6i0 input.svelte-fny6i0{flex:1;padding:0.5rem 0.75rem;border:1px solid var(--text-weak);border-radius:calc(var(--border-radius) * 0.4);background:transparent;color:inherit;font-family:inherit;font-size:0.85rem;outline:none}.email-form.svelte-fny6i0 input.svelte-fny6i0:focus{border-color:var(--accent-text)}.invite-btn.svelte-fny6i0.svelte-fny6i0{padding:0.5rem 0.85rem;border:none;border-radius:calc(var(--border-radius) * 0.4);background:var(--accent-text);color:var(--background);font-size:0.85rem;font-weight:var(--font-weight-bold);cursor:pointer;white-space:nowrap}.invite-btn.svelte-fny6i0.svelte-fny6i0:disabled{opacity:0.4;cursor:not-allowed}.email-error.svelte-fny6i0.svelte-fny6i0{color:hsl(0, 60%, 55%);font-size:0.8rem}.email-success.svelte-fny6i0.svelte-fny6i0{color:hsl(120, 45%, 50%);font-size:0.8rem}.generate-btn.svelte-fny6i0.svelte-fny6i0{padding:0.55rem 1rem;border:none;border-radius:calc(var(--border-radius) * 0.5);background:var(--accent-text);color:var(--background);font-size:0.85rem;font-weight:var(--font-weight-bold);cursor:pointer;transition:opacity var(--transition-speed) ease}.generate-btn.svelte-fny6i0.svelte-fny6i0:hover:not(:disabled){opacity:0.85}.generate-btn.svelte-fny6i0.svelte-fny6i0:disabled{opacity:0.5;cursor:not-allowed}.generate-btn.secondary.svelte-fny6i0.svelte-fny6i0{background:transparent;color:var(--accent-text);border:1px solid var(--accent-text);font-size:0.75rem;padding:0.35rem 0.65rem;margin-top:0.3rem}.link-container.svelte-fny6i0.svelte-fny6i0{display:flex;gap:0.4rem;align-items:center}.link-text.svelte-fny6i0.svelte-fny6i0{flex:1;padding:0.45rem 0.65rem;background:var(--background-accent-indent);border-radius:calc(var(--border-radius) * 0.4);font-size:0.75rem;word-break:break-all;font-family:monospace}.copy-btn.svelte-fny6i0.svelte-fny6i0{padding:0.45rem 0.65rem;border:none;border-radius:calc(var(--border-radius) * 0.4);background:var(--accent-text);color:var(--background);font-size:0.75rem;cursor:pointer;white-space:nowrap}.collaborators.svelte-fny6i0.svelte-fny6i0{display:flex;flex-direction:column;gap:0.4rem}.collaborator.svelte-fny6i0.svelte-fny6i0{display:flex;justify-content:space-between;align-items:center;padding:0.5rem 0.65rem;background:var(--background-accent-indent);border-radius:calc(var(--border-radius) * 0.5);gap:0.5rem}.collab-left.svelte-fny6i0.svelte-fny6i0{display:flex;align-items:center;gap:0.5rem;min-width:0;flex:1}.collab-avatar.svelte-fny6i0.svelte-fny6i0{width:30px;height:30px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:0.65rem;font-weight:bold;color:white;flex-shrink:0}.pending-avatar.svelte-fny6i0.svelte-fny6i0{background:hsl(40, 40%, 45%) !important}.collab-details.svelte-fny6i0.svelte-fny6i0{display:flex;flex-direction:column;min-width:0}.collab-name.svelte-fny6i0.svelte-fny6i0{font-size:0.85rem;font-weight:var(--font-weight-bold);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.collab-email.svelte-fny6i0.svelte-fny6i0{font-size:0.7rem;opacity:0.55;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.collab-right.svelte-fny6i0.svelte-fny6i0{display:flex;align-items:center;gap:0.4rem;flex-shrink:0}.permission-badge.svelte-fny6i0.svelte-fny6i0{font-size:0.65rem;padding:0.1rem 0.35rem;border-radius:3px;background:hsl(210, 40%, 40%);color:white;text-transform:uppercase}.remove-btn.svelte-fny6i0.svelte-fny6i0{padding:0.2rem 0.4rem;border:none;border-radius:3px;background:hsl(0, 50%, 45%);color:white;font-size:0.7rem;cursor:pointer}.remove-btn.svelte-fny6i0.svelte-fny6i0:hover{background:hsl(0, 50%, 55%)}",
  map: '{"version":3,"file":"ShareFlow.svelte","sources":["ShareFlow.svelte"],"sourcesContent":["<script lang=\\"ts\\">import {\\n  createShareInvite,\\n  listFlowShares,\\n  removeShare,\\n  shareFlowByEmail\\n} from \\"$lib/models/flowApi\\";\\nimport { currentCloudFlowId } from \\"$lib/models/store\\";\\nimport { flowPresence } from \\"$lib/models/flowSync\\";\\nimport { currentUser } from \\"$lib/models/auth\\";\\nlet inviteLink = \\"\\";\\nlet shares = [];\\nlet loading = false;\\nlet copied = false;\\nlet shareEmail = \\"\\";\\nlet shareEmailError = \\"\\";\\nlet shareEmailLoading = false;\\nlet shareEmailSuccess = false;\\n$: if ($currentCloudFlowId) {\\n  loadShares();\\n}\\n$: otherViewers = $flowPresence.filter(\\n  (u) => u.user_id !== $currentUser?.id\\n);\\nasync function loadShares() {\\n  if (!$currentCloudFlowId) return;\\n  shares = await listFlowShares($currentCloudFlowId);\\n}\\nasync function generateLink() {\\n  if (!$currentCloudFlowId) return;\\n  loading = true;\\n  const token = await createShareInvite($currentCloudFlowId, \\"edit\\");\\n  if (token) {\\n    inviteLink = `${window.location.origin}/app?invite=${token}`;\\n  }\\n  loading = false;\\n}\\nasync function copyLink() {\\n  if (!inviteLink) return;\\n  try {\\n    await navigator.clipboard.writeText(inviteLink);\\n    copied = true;\\n    setTimeout(() => copied = false, 2e3);\\n  } catch {\\n    const input = document.createElement(\\"input\\");\\n    input.value = inviteLink;\\n    document.body.appendChild(input);\\n    input.select();\\n    document.execCommand(\\"copy\\");\\n    document.body.removeChild(input);\\n    copied = true;\\n    setTimeout(() => copied = false, 2e3);\\n  }\\n}\\nasync function handleShareByEmail() {\\n  if (!$currentCloudFlowId || !shareEmail.trim()) return;\\n  shareEmailError = \\"\\";\\n  shareEmailSuccess = false;\\n  shareEmailLoading = true;\\n  const result = await shareFlowByEmail(\\n    $currentCloudFlowId,\\n    shareEmail.trim()\\n  );\\n  if (result.success) {\\n    shareEmailSuccess = true;\\n    shareEmail = \\"\\";\\n    await loadShares();\\n    setTimeout(() => shareEmailSuccess = false, 3e3);\\n  } else {\\n    shareEmailError = result.error || \\"Failed to share\\";\\n  }\\n  shareEmailLoading = false;\\n}\\nasync function handleRemoveShare(shareId) {\\n  await removeShare(shareId);\\n  shares = shares.filter((s) => s.id !== shareId);\\n}\\nfunction getInitials(name) {\\n  return name.split(\\" \\").map((w) => w[0]).join(\\"\\").toUpperCase().slice(0, 2) || \\"?\\";\\n}\\nfunction getAvatarColor(userId) {\\n  let hash = 0;\\n  for (let i = 0; i < userId.length; i++) {\\n    hash = userId.charCodeAt(i) + ((hash << 5) - hash);\\n  }\\n  const hue = Math.abs(hash) % 360;\\n  return `hsl(${hue}, 55%, 50%)`;\\n}\\n<\/script>\\n\\n<div class=\\"share-flow\\">\\n\\t<h3>Share this Flow</h3>\\n\\n\\t{#if !$currentCloudFlowId}\\n\\t\\t<p class=\\"warning\\">Save this flow first before sharing.</p>\\n\\t{:else}\\n\\t\\t<!-- Active viewers -->\\n\\t\\t{#if otherViewers.length > 0}\\n\\t\\t\\t<div class=\\"presence-section\\">\\n\\t\\t\\t\\t<div class=\\"presence-label\\">Currently viewing</div>\\n\\t\\t\\t\\t<div class=\\"presence-avatars\\">\\n\\t\\t\\t\\t\\t{#each otherViewers as viewer}\\n\\t\\t\\t\\t\\t\\t<div\\n\\t\\t\\t\\t\\t\\t\\tclass=\\"presence-avatar\\"\\n\\t\\t\\t\\t\\t\\t\\tstyle=\\"background: {getAvatarColor(viewer.user_id)}\\"\\n\\t\\t\\t\\t\\t\\t\\ttitle=\\"{viewer.display_name} ({viewer.email})\\"\\n\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t{getInitials(viewer.display_name)}\\n\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t{/each}\\n\\t\\t\\t\\t\\t<div class=\\"presence-names\\">\\n\\t\\t\\t\\t\\t\\t{#each otherViewers as viewer, i}\\n\\t\\t\\t\\t\\t\\t\\t<span class=\\"presence-name\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t>{viewer.display_name}{i <\\n\\t\\t\\t\\t\\t\\t\\t\\totherViewers.length - 1\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t? \\", \\"\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t: \\"\\"}</span\\n\\t\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t{/each}\\n\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t</div>\\n\\t\\t\\t</div>\\n\\t\\t{/if}\\n\\n\\t\\t<!-- Share by email -->\\n\\t\\t<div class=\\"email-section\\">\\n\\t\\t\\t<div class=\\"section-title\\">Invite by email</div>\\n\\t\\t\\t<form\\n\\t\\t\\t\\tclass=\\"email-form\\"\\n\\t\\t\\t\\ton:submit|preventDefault={handleShareByEmail}\\n\\t\\t\\t>\\n\\t\\t\\t\\t<input\\n\\t\\t\\t\\t\\ttype=\\"email\\"\\n\\t\\t\\t\\t\\tplaceholder=\\"partner@email.com\\"\\n\\t\\t\\t\\t\\tbind:value={shareEmail}\\n\\t\\t\\t\\t\\tdisabled={shareEmailLoading}\\n\\t\\t\\t\\t/>\\n\\t\\t\\t\\t<button\\n\\t\\t\\t\\t\\ttype=\\"submit\\"\\n\\t\\t\\t\\t\\tclass=\\"invite-btn\\"\\n\\t\\t\\t\\t\\tdisabled={shareEmailLoading || !shareEmail.trim()}\\n\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t{shareEmailLoading ? \\"...\\" : \\"Invite\\"}\\n\\t\\t\\t\\t</button>\\n\\t\\t\\t</form>\\n\\t\\t\\t{#if shareEmailError}\\n\\t\\t\\t\\t<div class=\\"email-error\\">{shareEmailError}</div>\\n\\t\\t\\t{/if}\\n\\t\\t\\t{#if shareEmailSuccess}\\n\\t\\t\\t\\t<div class=\\"email-success\\">Shared successfully!</div>\\n\\t\\t\\t{/if}\\n\\t\\t</div>\\n\\n\\t\\t<!-- Or share via link -->\\n\\t\\t<div class=\\"link-section\\">\\n\\t\\t\\t<div class=\\"section-title\\">Or share via link</div>\\n\\t\\t\\t{#if !inviteLink}\\n\\t\\t\\t\\t<button\\n\\t\\t\\t\\t\\tclass=\\"generate-btn\\"\\n\\t\\t\\t\\t\\ton:click={generateLink}\\n\\t\\t\\t\\t\\tdisabled={loading}\\n\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t{loading ? \\"Generating...\\" : \\"Generate Share Link\\"}\\n\\t\\t\\t\\t</button>\\n\\t\\t\\t{:else}\\n\\t\\t\\t\\t<div class=\\"link-container\\">\\n\\t\\t\\t\\t\\t<div class=\\"link-text\\">{inviteLink}</div>\\n\\t\\t\\t\\t\\t<button class=\\"copy-btn\\" on:click={copyLink}>\\n\\t\\t\\t\\t\\t\\t{copied ? \\"Copied!\\" : \\"Copy\\"}\\n\\t\\t\\t\\t\\t</button>\\n\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t<button\\n\\t\\t\\t\\t\\tclass=\\"generate-btn secondary\\"\\n\\t\\t\\t\\t\\ton:click={generateLink}\\n\\t\\t\\t\\t\\tdisabled={loading}\\n\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\tGenerate New Link\\n\\t\\t\\t\\t</button>\\n\\t\\t\\t{/if}\\n\\t\\t</div>\\n\\n\\t\\t<!-- Collaborators list -->\\n\\t\\t{#if shares.length > 0}\\n\\t\\t\\t<div class=\\"collaborators\\">\\n\\t\\t\\t\\t<div class=\\"section-title\\">Collaborators</div>\\n\\t\\t\\t\\t{#each shares as share}\\n\\t\\t\\t\\t\\t<div class=\\"collaborator\\">\\n\\t\\t\\t\\t\\t\\t<div class=\\"collab-left\\">\\n\\t\\t\\t\\t\\t\\t\\t{#if share.shared_with}\\n\\t\\t\\t\\t\\t\\t\\t\\t<div\\n\\t\\t\\t\\t\\t\\t\\t\\t\\tclass=\\"collab-avatar\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t\\tstyle=\\"background: {getAvatarColor(\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\tshare.shared_with\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t)}\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{getInitials(share.shared_with_name || \\"?\\")}\\n\\t\\t\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t\\t\\t\\t<div class=\\"collab-details\\">\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t<span class=\\"collab-name\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t>{share.shared_with_name ||\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\"Unknown\\"}</span\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t<span class=\\"collab-email\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t>{share.shared_with_email || \\"\\"}</span\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t\\t\\t{:else if share.invite_token}\\n\\t\\t\\t\\t\\t\\t\\t\\t<div class=\\"collab-avatar pending-avatar\\">\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t?\\n\\t\\t\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t\\t\\t\\t<div class=\\"collab-details\\">\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t<span class=\\"collab-name\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t>Pending invite</span\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t<span class=\\"collab-email\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t>Link not yet accepted</span\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t\\t<div class=\\"collab-right\\">\\n\\t\\t\\t\\t\\t\\t\\t<span class=\\"permission-badge\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t>{share.permission}</span\\n\\t\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t<button\\n\\t\\t\\t\\t\\t\\t\\t\\tclass=\\"remove-btn\\"\\n\\t\\t\\t\\t\\t\\t\\t\\ton:click={() => handleRemoveShare(share.id)}\\n\\t\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t\\tRemove\\n\\t\\t\\t\\t\\t\\t\\t</button>\\n\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t{/each}\\n\\t\\t\\t</div>\\n\\t\\t{/if}\\n\\t{/if}\\n</div>\\n\\n<style>\\n\\t.share-flow {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\tgap: 1.25rem;\\n\\t\\tpadding: 0.5rem;\\n\\t\\tmin-width: 360px;\\n\\t}\\n\\th3 {\\n\\t\\tmargin: 0;\\n\\t\\tfont-size: 1.2rem;\\n\\t}\\n\\t.section-title {\\n\\t\\tfont-size: 0.8rem;\\n\\t\\ttext-transform: uppercase;\\n\\t\\tletter-spacing: 0.04em;\\n\\t\\topacity: 0.55;\\n\\t\\tfont-weight: var(--font-weight-bold);\\n\\t\\tmargin-bottom: 0.4rem;\\n\\t}\\n\\t.warning {\\n\\t\\tmargin: 0;\\n\\t\\tcolor: hsl(40, 80%, 55%);\\n\\t\\tfont-size: 0.85rem;\\n\\t}\\n\\n\\t/* ─── Presence ─── */\\n\\t.presence-section {\\n\\t\\tbackground: var(--background-accent-indent);\\n\\t\\tborder-radius: calc(var(--border-radius) * 0.5);\\n\\t\\tpadding: 0.75rem;\\n\\t}\\n\\t.presence-label {\\n\\t\\tfont-size: 0.7rem;\\n\\t\\ttext-transform: uppercase;\\n\\t\\tletter-spacing: 0.04em;\\n\\t\\topacity: 0.5;\\n\\t\\tmargin-bottom: 0.4rem;\\n\\t}\\n\\t.presence-avatars {\\n\\t\\tdisplay: flex;\\n\\t\\talign-items: center;\\n\\t\\tgap: 0.35rem;\\n\\t\\tflex-wrap: wrap;\\n\\t}\\n\\t.presence-avatar {\\n\\t\\twidth: 28px;\\n\\t\\theight: 28px;\\n\\t\\tborder-radius: 50%;\\n\\t\\tdisplay: flex;\\n\\t\\talign-items: center;\\n\\t\\tjustify-content: center;\\n\\t\\tfont-size: 0.65rem;\\n\\t\\tfont-weight: bold;\\n\\t\\tcolor: white;\\n\\t\\tflex-shrink: 0;\\n\\t}\\n\\t.presence-names {\\n\\t\\tmargin-left: 0.35rem;\\n\\t\\tfont-size: 0.8rem;\\n\\t}\\n\\t.presence-name {\\n\\t\\tfont-weight: var(--font-weight-bold);\\n\\t}\\n\\n\\t/* ─── Email invite ─── */\\n\\t.email-form {\\n\\t\\tdisplay: flex;\\n\\t\\tgap: 0.4rem;\\n\\t}\\n\\t.email-form input {\\n\\t\\tflex: 1;\\n\\t\\tpadding: 0.5rem 0.75rem;\\n\\t\\tborder: 1px solid var(--text-weak);\\n\\t\\tborder-radius: calc(var(--border-radius) * 0.4);\\n\\t\\tbackground: transparent;\\n\\t\\tcolor: inherit;\\n\\t\\tfont-family: inherit;\\n\\t\\tfont-size: 0.85rem;\\n\\t\\toutline: none;\\n\\t}\\n\\t.email-form input:focus {\\n\\t\\tborder-color: var(--accent-text);\\n\\t}\\n\\t.invite-btn {\\n\\t\\tpadding: 0.5rem 0.85rem;\\n\\t\\tborder: none;\\n\\t\\tborder-radius: calc(var(--border-radius) * 0.4);\\n\\t\\tbackground: var(--accent-text);\\n\\t\\tcolor: var(--background);\\n\\t\\tfont-size: 0.85rem;\\n\\t\\tfont-weight: var(--font-weight-bold);\\n\\t\\tcursor: pointer;\\n\\t\\twhite-space: nowrap;\\n\\t}\\n\\t.invite-btn:disabled {\\n\\t\\topacity: 0.4;\\n\\t\\tcursor: not-allowed;\\n\\t}\\n\\t.email-error {\\n\\t\\tcolor: hsl(0, 60%, 55%);\\n\\t\\tfont-size: 0.8rem;\\n\\t}\\n\\t.email-success {\\n\\t\\tcolor: hsl(120, 45%, 50%);\\n\\t\\tfont-size: 0.8rem;\\n\\t}\\n\\n\\t/* ─── Link sharing ─── */\\n\\t.generate-btn {\\n\\t\\tpadding: 0.55rem 1rem;\\n\\t\\tborder: none;\\n\\t\\tborder-radius: calc(var(--border-radius) * 0.5);\\n\\t\\tbackground: var(--accent-text);\\n\\t\\tcolor: var(--background);\\n\\t\\tfont-size: 0.85rem;\\n\\t\\tfont-weight: var(--font-weight-bold);\\n\\t\\tcursor: pointer;\\n\\t\\ttransition: opacity var(--transition-speed) ease;\\n\\t}\\n\\t.generate-btn:hover:not(:disabled) {\\n\\t\\topacity: 0.85;\\n\\t}\\n\\t.generate-btn:disabled {\\n\\t\\topacity: 0.5;\\n\\t\\tcursor: not-allowed;\\n\\t}\\n\\t.generate-btn.secondary {\\n\\t\\tbackground: transparent;\\n\\t\\tcolor: var(--accent-text);\\n\\t\\tborder: 1px solid var(--accent-text);\\n\\t\\tfont-size: 0.75rem;\\n\\t\\tpadding: 0.35rem 0.65rem;\\n\\t\\tmargin-top: 0.3rem;\\n\\t}\\n\\t.link-container {\\n\\t\\tdisplay: flex;\\n\\t\\tgap: 0.4rem;\\n\\t\\talign-items: center;\\n\\t}\\n\\t.link-text {\\n\\t\\tflex: 1;\\n\\t\\tpadding: 0.45rem 0.65rem;\\n\\t\\tbackground: var(--background-accent-indent);\\n\\t\\tborder-radius: calc(var(--border-radius) * 0.4);\\n\\t\\tfont-size: 0.75rem;\\n\\t\\tword-break: break-all;\\n\\t\\tfont-family: monospace;\\n\\t}\\n\\t.copy-btn {\\n\\t\\tpadding: 0.45rem 0.65rem;\\n\\t\\tborder: none;\\n\\t\\tborder-radius: calc(var(--border-radius) * 0.4);\\n\\t\\tbackground: var(--accent-text);\\n\\t\\tcolor: var(--background);\\n\\t\\tfont-size: 0.75rem;\\n\\t\\tcursor: pointer;\\n\\t\\twhite-space: nowrap;\\n\\t}\\n\\n\\t/* ─── Collaborators ─── */\\n\\t.collaborators {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\tgap: 0.4rem;\\n\\t}\\n\\t.collaborator {\\n\\t\\tdisplay: flex;\\n\\t\\tjustify-content: space-between;\\n\\t\\talign-items: center;\\n\\t\\tpadding: 0.5rem 0.65rem;\\n\\t\\tbackground: var(--background-accent-indent);\\n\\t\\tborder-radius: calc(var(--border-radius) * 0.5);\\n\\t\\tgap: 0.5rem;\\n\\t}\\n\\t.collab-left {\\n\\t\\tdisplay: flex;\\n\\t\\talign-items: center;\\n\\t\\tgap: 0.5rem;\\n\\t\\tmin-width: 0;\\n\\t\\tflex: 1;\\n\\t}\\n\\t.collab-avatar {\\n\\t\\twidth: 30px;\\n\\t\\theight: 30px;\\n\\t\\tborder-radius: 50%;\\n\\t\\tdisplay: flex;\\n\\t\\talign-items: center;\\n\\t\\tjustify-content: center;\\n\\t\\tfont-size: 0.65rem;\\n\\t\\tfont-weight: bold;\\n\\t\\tcolor: white;\\n\\t\\tflex-shrink: 0;\\n\\t}\\n\\t.pending-avatar {\\n\\t\\tbackground: hsl(40, 40%, 45%) !important;\\n\\t}\\n\\t.collab-details {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\tmin-width: 0;\\n\\t}\\n\\t.collab-name {\\n\\t\\tfont-size: 0.85rem;\\n\\t\\tfont-weight: var(--font-weight-bold);\\n\\t\\toverflow: hidden;\\n\\t\\ttext-overflow: ellipsis;\\n\\t\\twhite-space: nowrap;\\n\\t}\\n\\t.collab-email {\\n\\t\\tfont-size: 0.7rem;\\n\\t\\topacity: 0.55;\\n\\t\\toverflow: hidden;\\n\\t\\ttext-overflow: ellipsis;\\n\\t\\twhite-space: nowrap;\\n\\t}\\n\\t.collab-right {\\n\\t\\tdisplay: flex;\\n\\t\\talign-items: center;\\n\\t\\tgap: 0.4rem;\\n\\t\\tflex-shrink: 0;\\n\\t}\\n\\t.permission-badge {\\n\\t\\tfont-size: 0.65rem;\\n\\t\\tpadding: 0.1rem 0.35rem;\\n\\t\\tborder-radius: 3px;\\n\\t\\tbackground: hsl(210, 40%, 40%);\\n\\t\\tcolor: white;\\n\\t\\ttext-transform: uppercase;\\n\\t}\\n\\t.remove-btn {\\n\\t\\tpadding: 0.2rem 0.4rem;\\n\\t\\tborder: none;\\n\\t\\tborder-radius: 3px;\\n\\t\\tbackground: hsl(0, 50%, 45%);\\n\\t\\tcolor: white;\\n\\t\\tfont-size: 0.7rem;\\n\\t\\tcursor: pointer;\\n\\t}\\n\\t.remove-btn:hover {\\n\\t\\tbackground: hsl(0, 50%, 55%);\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AA8OC,uCAAY,CACX,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,GAAG,CAAE,OAAO,CACZ,OAAO,CAAE,MAAM,CACf,SAAS,CAAE,KACZ,CACA,8BAAG,CACF,MAAM,CAAE,CAAC,CACT,SAAS,CAAE,MACZ,CACA,0CAAe,CACd,SAAS,CAAE,MAAM,CACjB,cAAc,CAAE,SAAS,CACzB,cAAc,CAAE,MAAM,CACtB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,IAAI,kBAAkB,CAAC,CACpC,aAAa,CAAE,MAChB,CACA,oCAAS,CACR,MAAM,CAAE,CAAC,CACT,KAAK,CAAE,IAAI,EAAE,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CACxB,SAAS,CAAE,OACZ,CAGA,6CAAkB,CACjB,UAAU,CAAE,IAAI,0BAA0B,CAAC,CAC3C,aAAa,CAAE,KAAK,IAAI,eAAe,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAC/C,OAAO,CAAE,OACV,CACA,2CAAgB,CACf,SAAS,CAAE,MAAM,CACjB,cAAc,CAAE,SAAS,CACzB,cAAc,CAAE,MAAM,CACtB,OAAO,CAAE,GAAG,CACZ,aAAa,CAAE,MAChB,CACA,6CAAkB,CACjB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,GAAG,CAAE,OAAO,CACZ,SAAS,CAAE,IACZ,CACA,4CAAiB,CAChB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,aAAa,CAAE,GAAG,CAClB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,CACvB,SAAS,CAAE,OAAO,CAClB,WAAW,CAAE,IAAI,CACjB,KAAK,CAAE,KAAK,CACZ,WAAW,CAAE,CACd,CACA,2CAAgB,CACf,WAAW,CAAE,OAAO,CACpB,SAAS,CAAE,MACZ,CACA,0CAAe,CACd,WAAW,CAAE,IAAI,kBAAkB,CACpC,CAGA,uCAAY,CACX,OAAO,CAAE,IAAI,CACb,GAAG,CAAE,MACN,CACA,yBAAW,CAAC,mBAAM,CACjB,IAAI,CAAE,CAAC,CACP,OAAO,CAAE,MAAM,CAAC,OAAO,CACvB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,WAAW,CAAC,CAClC,aAAa,CAAE,KAAK,IAAI,eAAe,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAC/C,UAAU,CAAE,WAAW,CACvB,KAAK,CAAE,OAAO,CACd,WAAW,CAAE,OAAO,CACpB,SAAS,CAAE,OAAO,CAClB,OAAO,CAAE,IACV,CACA,yBAAW,CAAC,mBAAK,MAAO,CACvB,YAAY,CAAE,IAAI,aAAa,CAChC,CACA,uCAAY,CACX,OAAO,CAAE,MAAM,CAAC,OAAO,CACvB,MAAM,CAAE,IAAI,CACZ,aAAa,CAAE,KAAK,IAAI,eAAe,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAC/C,UAAU,CAAE,IAAI,aAAa,CAAC,CAC9B,KAAK,CAAE,IAAI,YAAY,CAAC,CACxB,SAAS,CAAE,OAAO,CAClB,WAAW,CAAE,IAAI,kBAAkB,CAAC,CACpC,MAAM,CAAE,OAAO,CACf,WAAW,CAAE,MACd,CACA,uCAAW,SAAU,CACpB,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,WACT,CACA,wCAAa,CACZ,KAAK,CAAE,IAAI,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CACvB,SAAS,CAAE,MACZ,CACA,0CAAe,CACd,KAAK,CAAE,IAAI,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CACzB,SAAS,CAAE,MACZ,CAGA,yCAAc,CACb,OAAO,CAAE,OAAO,CAAC,IAAI,CACrB,MAAM,CAAE,IAAI,CACZ,aAAa,CAAE,KAAK,IAAI,eAAe,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAC/C,UAAU,CAAE,IAAI,aAAa,CAAC,CAC9B,KAAK,CAAE,IAAI,YAAY,CAAC,CACxB,SAAS,CAAE,OAAO,CAClB,WAAW,CAAE,IAAI,kBAAkB,CAAC,CACpC,MAAM,CAAE,OAAO,CACf,UAAU,CAAE,OAAO,CAAC,IAAI,kBAAkB,CAAC,CAAC,IAC7C,CACA,yCAAa,MAAM,KAAK,SAAS,CAAE,CAClC,OAAO,CAAE,IACV,CACA,yCAAa,SAAU,CACtB,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,WACT,CACA,aAAa,sCAAW,CACvB,UAAU,CAAE,WAAW,CACvB,KAAK,CAAE,IAAI,aAAa,CAAC,CACzB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,aAAa,CAAC,CACpC,SAAS,CAAE,OAAO,CAClB,OAAO,CAAE,OAAO,CAAC,OAAO,CACxB,UAAU,CAAE,MACb,CACA,2CAAgB,CACf,OAAO,CAAE,IAAI,CACb,GAAG,CAAE,MAAM,CACX,WAAW,CAAE,MACd,CACA,sCAAW,CACV,IAAI,CAAE,CAAC,CACP,OAAO,CAAE,OAAO,CAAC,OAAO,CACxB,UAAU,CAAE,IAAI,0BAA0B,CAAC,CAC3C,aAAa,CAAE,KAAK,IAAI,eAAe,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAC/C,SAAS,CAAE,OAAO,CAClB,UAAU,CAAE,SAAS,CACrB,WAAW,CAAE,SACd,CACA,qCAAU,CACT,OAAO,CAAE,OAAO,CAAC,OAAO,CACxB,MAAM,CAAE,IAAI,CACZ,aAAa,CAAE,KAAK,IAAI,eAAe,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAC/C,UAAU,CAAE,IAAI,aAAa,CAAC,CAC9B,KAAK,CAAE,IAAI,YAAY,CAAC,CACxB,SAAS,CAAE,OAAO,CAClB,MAAM,CAAE,OAAO,CACf,WAAW,CAAE,MACd,CAGA,0CAAe,CACd,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,GAAG,CAAE,MACN,CACA,yCAAc,CACb,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,MAAM,CAAC,OAAO,CACvB,UAAU,CAAE,IAAI,0BAA0B,CAAC,CAC3C,aAAa,CAAE,KAAK,IAAI,eAAe,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAC/C,GAAG,CAAE,MACN,CACA,wCAAa,CACZ,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,GAAG,CAAE,MAAM,CACX,SAAS,CAAE,CAAC,CACZ,IAAI,CAAE,CACP,CACA,0CAAe,CACd,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,aAAa,CAAE,GAAG,CAClB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,CACvB,SAAS,CAAE,OAAO,CAClB,WAAW,CAAE,IAAI,CACjB,KAAK,CAAE,KAAK,CACZ,WAAW,CAAE,CACd,CACA,2CAAgB,CACf,UAAU,CAAE,IAAI,EAAE,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,UAC/B,CACA,2CAAgB,CACf,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,SAAS,CAAE,CACZ,CACA,wCAAa,CACZ,SAAS,CAAE,OAAO,CAClB,WAAW,CAAE,IAAI,kBAAkB,CAAC,CACpC,QAAQ,CAAE,MAAM,CAChB,aAAa,CAAE,QAAQ,CACvB,WAAW,CAAE,MACd,CACA,yCAAc,CACb,SAAS,CAAE,MAAM,CACjB,OAAO,CAAE,IAAI,CACb,QAAQ,CAAE,MAAM,CAChB,aAAa,CAAE,QAAQ,CACvB,WAAW,CAAE,MACd,CACA,yCAAc,CACb,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,GAAG,CAAE,MAAM,CACX,WAAW,CAAE,CACd,CACA,6CAAkB,CACjB,SAAS,CAAE,OAAO,CAClB,OAAO,CAAE,MAAM,CAAC,OAAO,CACvB,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,IAAI,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAC9B,KAAK,CAAE,KAAK,CACZ,cAAc,CAAE,SACjB,CACA,uCAAY,CACX,OAAO,CAAE,MAAM,CAAC,MAAM,CACtB,MAAM,CAAE,IAAI,CACZ,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,IAAI,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAC5B,KAAK,CAAE,KAAK,CACZ,SAAS,CAAE,MAAM,CACjB,MAAM,CAAE,OACT,CACA,uCAAW,MAAO,CACjB,UAAU,CAAE,IAAI,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAC5B"}'
};
function getInitials$1(name) {
  return name.split(" ").map((w) => w[0]).join("").toUpperCase().slice(0, 2) || "?";
}
function getAvatarColor$1(userId) {
  let hash = 0;
  for (let i = 0; i < userId.length; i++) {
    hash = userId.charCodeAt(i) + ((hash << 5) - hash);
  }
...
const ShareFlow = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let otherViewers;
  let $currentCloudFlowId, $$unsubscribe_currentCloudFlowId;
  let $currentUser, $$unsubscribe_currentUser;
  let $flowPresence, $$unsubscribe_flowPresence;
  ...
  $$unsubscribe_flowPresence = subscribe(flowPresence, (value) => $flowPresence = value);
  let shares = [];
  let shareEmail = "";
  async function loadShares() {
    if (!$currentCloudFlowId) return;
  ...
  $$unsubscribe_flowPresence();
  return `<div class="share-flow svelte-fny6i0"><h3 class="svelte-fny6i0" data-svelte-h="svelte-upu1qv">Share this Flow</h3> ${!$currentCloudFlowId ? `<p class="warning svelte-fny6i0" data-svelte-h="svelte-uttth">Save this flow first before sharing.</p>` : ` ${otherViewers.length > 0 ? `<div class="presence-section svelte-fny6i0"><div class="presence-label svelte-fny6i0" data-svelte-h="svelte-1d6m3os">Currently viewing</div> <div class="presence-avatars svelte-fny6i0">${each(otherViewers, (viewer) => {
    return `<div class="presence-avatar svelte-fny6i0" style="${"background: " + escape(getAvatarColor$1(viewer.user_id), true)}" title="${escape(viewer.display_name, true) + " (" + escape(viewer.email, true) + ")"}">${escape(getInitials$1(viewer.display_name))} </div>`;
  })} <div class="presence-names svelte-fny6i0">${each(otherViewers, (viewer, i) => {
    return `<span class="presence-name svelte-fny6i0">${escape(viewer.display_name)}${escape(i < otherViewers.length - 1 ? ", " : "")}</span>`;
  })}</div></div></div>` : ``}  <div class="email-section"><div class="section-title svelte-fny6i0" data-svelte-h="svelte-m7wvk5">Invite by email</div> <form class="email-form svelte-fny6i0"><input type="email" placeholder="partner@email.com" ${""} class="svelte-fny6i0"${add_attribute("value", shareEmail, 0)}> <button type="submit" class="invite-btn svelte-fny6i0" ${!shareEmail.trim() ? "disabled" : ""}>${escape("Invite")}</button></form> ${``} ${``}</div>  <div class="link-section"><div class="section-title svelte-fny6i0" data-svelte-h="svelte-15gwjvh">Or share via link</div> ${`<button class="generate-btn svelte-fny6i0" ${""}>${escape("Generate Share Link")}</button>`}</div>  ${shares.length > 0 ? `<div class="collaborators svelte-fny6i0"><div class="section-title svelte-fny6i0" data-svelte-h="svelte-1nxtb5u">Collaborators</div> ${each(shares, (share) => {
    return `<div class="collaborator svelte-fny6i0"><div class="collab-left svelte-fny6i0">${share.shared_with ? `<div class="collab-avatar svelte-fny6i0" style="${"background: " + escape(getAvatarColor$1(share.shared_with), true)}">${escape(getInitials$1(share.shared_with_name || "?"))}</div> <div class="collab-details svelte-fny6i0"><span class="collab-name svelte-fny6i0">${escape(share.shared_with_name || "Unknown")}</span> <span class="collab-email svelte-fny6i0">${escape(share.shared_with_email || "")}</span> </div>` : `${share.invite_token ? `<div class="collab-avatar pending-avatar svelte-fny6i0" data-svelte-h="svelte-l7d4xj">?</div> <div class="collab-details svelte-fny6i0" data-svelte-h="svelte-1gf1azq"><span class="collab-name svelte-fny6i0">Pending invite</span> <span class="collab-email svelte-fny6i0">Link not yet accepted</span> </div>` : ``}`}</div> <div class="collab-right svelte-fny6i0"><span class="permission-badge svelte-fny6i0">${escape(share.permission)}</span> <button class="remove-btn svelte-fny6i0" data-svelte-h="svelte-1xhbhme">Remove
							</button></div> </div>`;
  })}</div>` : ``}`} </div>`;
});
const css = {
  code: 'body.app{overflow-x:auto;overflow-y:clip}.grid.svelte-k3vrvb.svelte-k3vrvb{display:grid;gap:var(--gap);grid-template-areas:"sidebar title box-control presence"\n      "sidebar flow flow flow";grid-template-columns:var(--sidebar-width) 1fr auto auto;padding:var(--main-margin);width:100%;height:100%;box-sizing:border-box;position:relative}.grid.svelte-k3vrvb.svelte-k3vrvb:has(.side-doc){grid-template-areas:"sidebar title box-control presence side-doc"\n      "sidebar flow flow flow side-doc";grid-template-columns:var(--sidebar-width) 1fr auto auto auto}.grid.showPrelude.svelte-k3vrvb.svelte-k3vrvb{grid-template-areas:"sidebar prelude";grid-template-columns:var(--sidebar-width) auto}.sidebar.svelte-k3vrvb.svelte-k3vrvb{background:var(--background);width:100%;height:var(--main-height);border-radius:var(--border-radius);padding:var(--padding);grid-area:sidebar;display:flex;flex-direction:column;box-sizing:border-box}.header.svelte-k3vrvb.svelte-k3vrvb{height:auto;padding-bottom:var(--padding)}.tabs.svelte-k3vrvb.svelte-k3vrvb{overflow-y:auto;height:var(--main-height);box-sizing:border-box;position:relative}.tabScroll.svelte-k3vrvb.svelte-k3vrvb{padding:0;margin:0;padding-top:0;padding-bottom:calc(var(--view-height) * 0.6)}.title.svelte-k3vrvb.svelte-k3vrvb{background:var(--background);border-radius:var(--border-radius);width:100%;grid-area:title;height:var(--title-height)}.box-control.svelte-k3vrvb.svelte-k3vrvb{background:var(--background);border-radius:var(--border-radius);width:100%;grid-area:box-control;height:var(--title-height)}.flow.svelte-k3vrvb.svelte-k3vrvb{width:100%;overflow-x:auto;overflow-y:clip;background:var(--background);z-index:0;border-radius:var(--border-radius);grid-area:flow;height:var(--view-height)}.prelude.svelte-k3vrvb.svelte-k3vrvb{position:relative;width:calc(100vw - var(--sidebar-width) - var(--gap) * 3);height:var(--main-height);grid-area:prelude}.side-doc.svelte-k3vrvb.svelte-k3vrvb{position:relative;width:var(--side-doc-width);height:var(--main-height);grid-area:side-doc}.cloud-status.svelte-k3vrvb.svelte-k3vrvb{padding:0.25rem 0;text-align:center}.save-indicator.svelte-k3vrvb.svelte-k3vrvb{font-size:0.75rem;opacity:0.5;transition:opacity 0.3s ease}.save-indicator.saving.svelte-k3vrvb.svelte-k3vrvb{opacity:0.8}.save-indicator.saved.svelte-k3vrvb.svelte-k3vrvb{opacity:0.7;color:hsl(120, 40%, 55%)}.save-indicator.error.svelte-k3vrvb.svelte-k3vrvb{opacity:1;color:hsl(0, 60%, 55%)}.cloud-flows-section.svelte-k3vrvb.svelte-k3vrvb{display:flex;flex-direction:column;gap:2px;margin-bottom:0.25rem}.section-label.svelte-k3vrvb.svelte-k3vrvb{font-size:0.7rem;text-transform:uppercase;letter-spacing:0.05em;opacity:0.5;padding:0.35rem 0.5rem 0.15rem;font-weight:var(--font-weight-bold)}.section-divider.svelte-k3vrvb.svelte-k3vrvb{height:1px;background:currentColor;opacity:0.1;margin:0.5rem 0}.cloud-flow-item-wrapper.svelte-k3vrvb.svelte-k3vrvb{display:flex;align-items:center;gap:0;position:relative}.cloud-flow-edit-input.svelte-k3vrvb.svelte-k3vrvb{flex:1;padding:0.35rem 0.5rem;border:1px solid var(--accent-text);border-radius:calc(var(--border-radius) * 0.4);background:var(--background-accent-indent);color:inherit;font-family:inherit;font-size:0.85rem;outline:none}.cloud-flow-action.svelte-k3vrvb.svelte-k3vrvb{background:none;border:none;color:inherit;font-size:1rem;cursor:pointer;padding:0.15rem 0.3rem;opacity:0;transition:opacity var(--transition-speed) ease;flex-shrink:0;line-height:1}.cloud-flow-item-wrapper.svelte-k3vrvb:hover .cloud-flow-action.svelte-k3vrvb{opacity:0.45}.cloud-flow-action.svelte-k3vrvb.svelte-k3vrvb:hover{opacity:1 !important}.cloud-flow-delete.svelte-k3vrvb.svelte-k3vrvb:hover{color:hsl(0, 60%, 55%)}.cloud-flow-edit.svelte-k3vrvb.svelte-k3vrvb:hover{color:var(--accent-text)}.cloud-flow-item.svelte-k3vrvb.svelte-k3vrvb{display:flex;align-items:center;justify-content:space-between;width:100%;padding:0.4rem 0.5rem;border:none;border-radius:calc(var(--border-radius) * 0.4);background:transparent;color:inherit;font-family:inherit;font-size:0.85rem;cursor:pointer;text-align:left;transition:background var(--transition-speed) ease}.cloud-flow-item.svelte-k3vrvb.svelte-k3vrvb:hover{background:var(--background-accent-indent)}.cloud-flow-item.active.svelte-k3vrvb.svelte-k3vrvb{background:var(--background-accent-active)}.cloud-flow-item.svelte-k3vrvb .flow-title.svelte-k3vrvb{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;flex:1}.shared-badge.svelte-k3vrvb.svelte-k3vrvb{font-size:0.65rem;padding:0.1rem 0.35rem;border-radius:3px;background:hsl(210, 50%, 45%);color:white;margin-left:0.5rem;flex-shrink:0}.new-flow-btn.svelte-k3vrvb.svelte-k3vrvb{width:100%;padding:0.4rem 0.5rem;border:1px dashed currentColor;border-radius:calc(var(--border-radius) * 0.4);background:transparent;color:inherit;font-family:inherit;font-size:0.8rem;cursor:pointer;opacity:0.5;transition:opacity var(--transition-speed) ease}.new-flow-btn.svelte-k3vrvb.svelte-k3vrvb:hover{opacity:0.8}.sidebar-footer.svelte-k3vrvb.svelte-k3vrvb{display:flex;flex-direction:column;gap:0.35rem;padding-top:0.5rem;margin-top:auto}.sidebar-action-btn.svelte-k3vrvb.svelte-k3vrvb{width:100%;padding:0.45rem 0.5rem;border:none;border-radius:calc(var(--border-radius) * 0.4);font-family:inherit;font-size:0.8rem;cursor:pointer;transition:opacity var(--transition-speed) ease}.sidebar-action-btn.svelte-k3vrvb.svelte-k3vrvb:hover:not(:disabled){opacity:0.85}.sidebar-action-btn.svelte-k3vrvb.svelte-k3vrvb:disabled{opacity:0.35;cursor:not-allowed}.share-btn.svelte-k3vrvb.svelte-k3vrvb{background:var(--accent-text);color:var(--background);font-weight:var(--font-weight-bold)}.signout-btn.svelte-k3vrvb.svelte-k3vrvb{background:transparent;color:inherit;opacity:0.5;border:1px solid currentColor}.signout-btn.svelte-k3vrvb.svelte-k3vrvb:hover{opacity:0.7 !important}.loading-message.svelte-k3vrvb.svelte-k3vrvb{display:flex;align-items:center;justify-content:center;width:100%;height:100%;opacity:0.5;font-size:1.1rem}.presence-strip.svelte-k3vrvb.svelte-k3vrvb{display:flex;align-items:center;gap:-4px;padding:0 0.5rem;height:var(--title-height);grid-area:presence}.viewer-avatar.svelte-k3vrvb.svelte-k3vrvb{width:26px;height:26px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:0.6rem;font-weight:bold;color:white;border:2px solid var(--background);margin-left:-4px;cursor:default;flex-shrink:0}.viewer-avatar.svelte-k3vrvb.svelte-k3vrvb:first-child{margin-left:0}',
  map: '{"version":3,"file":"+page.svelte","sources":["+page.svelte"],"sourcesContent":["<script lang=\\"ts\\">import Flow from \\"$lib/components/Flow.svelte\\";\\nimport Title from \\"$lib/components/Title.svelte\\";\\nimport BoxControl from \\"$lib/components/BoxControl.svelte\\";\\nimport ButtonBar from \\"$lib/components/ButtonBar.svelte\\";\\nimport DownloadUpload from \\"$lib/components/DownloadUpload.svelte\\";\\nimport Message from \\"$lib/components/Message.svelte\\";\\nimport Settings from \\"$lib/components/Settings.svelte\\";\\nimport SortableList from \\"$lib/components/SortableList.svelte\\";\\nimport AddTab from \\"$lib/components/AddTab.svelte\\";\\nimport Share from \\"$lib/components/Share.svelte\\";\\nimport Tab from \\"$lib/components/Tab.svelte\\";\\nimport { dev } from \\"$app/environment\\";\\nimport { openPopup } from \\"$lib/models/popup\\";\\nimport { onDestroy, onMount } from \\"svelte\\";\\nimport {\\n  activeMouse,\\n  flowsChange,\\n  nodes,\\n  pendingAction,\\n  currentCloudFlowId,\\n  cloudFlowList,\\n  saveStatus\\n} from \\"$lib/models/store\\";\\nimport { createKeyDownHandler } from \\"$lib/models/key\\";\\nimport Prelude from \\"$lib/components/Prelude.svelte\\";\\nimport { loadNodes, importSettingsJson } from \\"$lib/models/file\\";\\nimport Timers from \\"$lib/components/Timers.svelte\\";\\nimport Help from \\"$lib/components/Help.svelte\\";\\nimport { settings } from \\"$lib/models/settings\\";\\nimport SideDoc from \\"$lib/components/SideDoc.svelte\\";\\nimport { history } from \\"$lib/models/history\\";\\nimport { focusId, lastFocusIds, selectedFlowId } from \\"$lib/models/focus\\";\\nimport { isChangelogVersionCurrent } from \\"$lib/models/version\\";\\nimport {\\n  addNewFlow,\\n  deleteFlow,\\n  moveFlow,\\n  replaceNodes\\n} from \\"$lib/models/nodeDecorateAction\\";\\nimport {\\n  getDebateStyleFlow\\n} from \\"$lib/models/debateStyle\\";\\nimport Auth from \\"$lib/components/Auth.svelte\\";\\nimport ShareFlow from \\"$lib/components/ShareFlow.svelte\\";\\nimport {\\n  isLoggedIn,\\n  authLoading,\\n  signOut,\\n  currentUser\\n} from \\"$lib/models/auth\\";\\nimport {\\n  openCloudFlow,\\n  deleteCloudFlow,\\n  startNewCloudFlow,\\n  refreshFlowList\\n} from \\"$lib/models/autoSave\\";\\nimport { newNodes } from \\"$lib/models/store\\";\\nimport { saveFlow as saveFlowApi } from \\"$lib/models/flowApi\\";\\nimport { flowPresence } from \\"$lib/models/flowSync\\";\\n$: otherViewers = $flowPresence.filter((u) => u.user_id !== $currentUser?.id);\\nfunction getInitials(name) {\\n  return name.split(\\" \\").map((w) => w[0]).join(\\"\\").toUpperCase().slice(0, 2) || \\"?\\";\\n}\\nfunction getAvatarColor(userId) {\\n  let hash = 0;\\n  for (let i = 0; i < userId.length; i++) {\\n    hash = userId.charCodeAt(i) + ((hash << 5) - hash);\\n  }\\n  return `hsl(${Math.abs(hash) % 360}, 55%, 50%)`;\\n}\\nlet editingFlowId = null;\\nlet editingFlowTitle = \\"\\";\\nfunction startEditingFlow(flowId, currentTitle) {\\n  editingFlowId = flowId;\\n  editingFlowTitle = currentTitle;\\n  setTimeout(() => {\\n    const input = document.getElementById(\\"cloud-flow-edit-input\\");\\n    if (input) {\\n      input.select();\\n      input.focus();\\n    }\\n  }, 0);\\n}\\nasync function finishEditingFlow() {\\n  if (editingFlowId && editingFlowTitle.trim()) {\\n    await saveFlowApi(editingFlowId, void 0, editingFlowTitle.trim());\\n    await refreshFlowList();\\n  }\\n  editingFlowId = null;\\n  editingFlowTitle = \\"\\";\\n}\\nasync function handleDeleteCloudFlow(flowId, title) {\\n  if (confirm(`Delete flow \\"${title || \\"Untitled\\"}\\"? This cannot be undone.`)) {\\n    await deleteCloudFlow(flowId);\\n  }\\n}\\n$: unsavedChanges = $nodes.root.children.length > 0;\\nonMount(() => {\\n  window.addEventListener(\\n    \\"dragover\\",\\n    function(e) {\\n      e.preventDefault();\\n    },\\n    false\\n  );\\n  window.addEventListener(\\n    \\"drop\\",\\n    function(e) {\\n      e.preventDefault();\\n    },\\n    false\\n  );\\n  window.addEventListener(\\"beforeunload\\", function(e) {\\n    if (unsavedChanges && !dev) {\\n      let confirmationMessage = \\"Are you sure you want to leave?\\";\\n      e.returnValue = confirmationMessage;\\n      return confirmationMessage;\\n    }\\n  });\\n});\\nlet showSideDoc = settings.data[\\"showSideDoc\\"].value;\\nonDestroy(\\n  settings.subscribe([\\"showSideDoc\\"], (key) => {\\n    showSideDoc = settings.data[key].value;\\n  })\\n);\\nfunction clickTab(id) {\\n  blurFlow();\\n  $selectedFlowId = id;\\n  focusFlow();\\n}\\nfunction focusFlow() {\\n  if ($selectedFlowId == null) return;\\n  let lastFocus = $lastFocusIds[$selectedFlowId];\\n  if (lastFocus == null) {\\n    lastFocus = $selectedFlowId;\\n  }\\n  $focusId = lastFocus;\\n}\\nfunction blurFlow() {\\n  $focusId = null;\\n}\\nfunction addFlow(style) {\\n  blurFlow();\\n  let id = addNewFlow($nodes.root.children.length, style, switchSpeakers);\\n  if (id != null) {\\n    $selectedFlowId = id;\\n    focusFlow();\\n  }\\n}\\nasync function deleteFlowAndFocus() {\\n  if ($selectedFlowId == null) return;\\n  blurFlow();\\n  let oldIndex = $nodes.root.children.indexOf($selectedFlowId);\\n  deleteFlow($selectedFlowId);\\n  let nextIndex;\\n  if (oldIndex == 0) {\\n    nextIndex = 0;\\n  } else {\\n    nextIndex = oldIndex - 1;\\n  }\\n  if ($nodes.root.children.length > 0) {\\n    $selectedFlowId = $nodes.root.children[nextIndex];\\n    focusFlow();\\n  } else {\\n    $selectedFlowId = null;\\n  }\\n}\\nfunction handleSort(e) {\\n  let { from, to } = e.detail;\\n  if (from > to) {\\n    to += 1;\\n  }\\n  moveFlow($nodes.root.children[from], to);\\n}\\nfunction handleMouseMove(e) {\\n  $activeMouse = true;\\n}\\nconst keyDownHandler = createKeyDownHandler({\\n  control: {\\n    n: {\\n      handle: () => {\\n        const style = getDebateStyleFlow(\\"primary\\");\\n        if (style == null) return;\\n        addFlow(style);\\n      },\\n      require: () => getDebateStyleFlow(\\"primary\\") != null\\n    }\\n  },\\n  \\"control shift\\": {\\n    n: {\\n      handle: () => {\\n        const style = getDebateStyleFlow(\\"secondary\\");\\n        if (style == null) return;\\n        addFlow(style);\\n      },\\n      require: () => getDebateStyleFlow(\\"secondary\\") != null\\n    }\\n  },\\n  \\"commandControl shift\\": {\\n    z: {\\n      handle: () => {\\n        if ($selectedFlowId == null) return;\\n        history.redo($selectedFlowId, $pendingAction);\\n      },\\n      require: () => {\\n        if ($selectedFlowId == null) return false;\\n        return history.canRedo($selectedFlowId, $pendingAction);\\n      },\\n      stopRepeat: false,\\n      preventDefault: \\"always\\"\\n    }\\n  },\\n  commandControl: {\\n    z: {\\n      handle: () => {\\n        if ($selectedFlowId == null) return;\\n        history.undo($selectedFlowId, $pendingAction);\\n      },\\n      require: () => {\\n        if ($selectedFlowId == null) return false;\\n        return history.canUndo($selectedFlowId, $pendingAction);\\n      },\\n      stopRepeat: false,\\n      preventDefault: \\"always\\"\\n    }\\n  },\\n  \\"commandControl alt\\": {\\n    ArrowUp: {\\n      handle: () => {\\n        if ($selectedFlowId == null) return;\\n        let index = ($nodes.root.children.indexOf($selectedFlowId) - 1) % $nodes.root.children.length;\\n        if (index < 0) {\\n          index = $nodes.root.children.length - 1;\\n        }\\n        clickTab($nodes.root.children[index]);\\n      },\\n      require: () => $nodes.root.children.length > 0,\\n      stopRepeat: false\\n    },\\n    ArrowDown: {\\n      handle: () => {\\n        if ($selectedFlowId == null) return;\\n        let index = ($nodes.root.children.indexOf($selectedFlowId) + 1) % $nodes.root.children.length;\\n        clickTab($nodes.root.children[index]);\\n      },\\n      require: () => $nodes.root.children.length > 0,\\n      stopRepeat: false\\n    }\\n  }\\n});\\nfunction handleKeydown(e) {\\n  $activeMouse = false;\\n  keyDownHandler(e);\\n}\\nfunction readUploadDragged(e) {\\n  e.preventDefault();\\n  let file = e?.dataTransfer?.files[0];\\n  if (file == void 0) {\\n    return;\\n  }\\n  let reader = new FileReader();\\n  reader.onload = function(fileLoadedEvent) {\\n    let uploadData = fileLoadedEvent.target?.result;\\n    if (uploadData == void 0) return;\\n    handleUpload(uploadData.toString());\\n  };\\n  if (file.type == \\"text/plain\\") {\\n    reader.readAsText(file, \\"UTF-8\\");\\n  } else if (file.type == \\"application/json\\") {\\n    reader.readAsText(file, \\"UTF-8\\");\\n  } else {\\n    openPopup(Message, \\"File Message\\", {\\n      message: \\"Invalid file\\",\\n      error: true\\n    });\\n  }\\n}\\nfunction readUpload() {\\n  const fileInput = document.getElementById(\\"uploadId\\");\\n  if (!fileInput?.files?.length) return;\\n  const file = fileInput.files[0];\\n  let reader = new FileReader();\\n  reader.onload = function(fileLoadedEvent) {\\n    let uploadData = fileLoadedEvent.target?.result;\\n    if (uploadData == void 0) return;\\n    handleUpload(uploadData.toString());\\n    fileInput.value = \\"\\";\\n  };\\n  reader.readAsText(file, \\"UTF-8\\");\\n}\\nfunction preventDefault(e) {\\n  e.preventDefault();\\n}\\nasync function handleUpload(data) {\\n  let dataObj = JSON.parse(data);\\n  if (dataObj[\\"isSettings\\"]) {\\n    importSettingsJson(dataObj);\\n    return;\\n  }\\n  let newNodes2 = null;\\n  try {\\n    newNodes2 = loadNodes(dataObj);\\n  } catch (e) {\\n    openPopup(Message, \\"File Message\\", {\\n      message: \\"Invalid file\\",\\n      error: true\\n    });\\n  }\\n  if (newNodes2 != null) {\\n    if (!unsavedChanges || confirm(\\"Are you sure you want to overwrite your current flows?\\")) {\\n      replaceNodes(newNodes2);\\n      $selectedFlowId = null;\\n      flowsChange();\\n    }\\n  }\\n}\\nlet switchSpeakers = false;\\nonMount(() => {\\n  document.body.classList.add(\\"app\\");\\n});\\nonDestroy(() => {\\n  document.body.classList.remove(\\"app\\");\\n  document.body.classList.remove(\\"customScrollbar\\");\\n});\\n$: {\\n  if (settings.data.customScrollbar.value) {\\n    document.body.classList.add(\\"customScrollbar\\");\\n  } else {\\n    document.body.classList.remove(\\"customScrollbar\\");\\n  }\\n}\\nfunction fixScroll(event) {\\n  const el = event.currentTarget;\\n  if (el.scrollTop !== 0) {\\n    el.scrollTop = 0;\\n  }\\n}\\n<\/script>\\n\\n<svelte:body\\n  on:keydown={handleKeydown}\\n  on:mousemove={handleMouseMove}\\n  on:dragenter={preventDefault}\\n  on:drop={readUploadDragged}\\n/>\\n<main class:activeMouse class=\\"palette-plain\\">\\n  <input id=\\"uploadId\\" type=\\"file\\" hidden on:change={readUpload} />\\n  <div class=\\"grid\\" class:showPrelude={!($nodes.root.children.length > 0)}>\\n    <div class=\\"sidebar\\">\\n      <div class=\\"header\\">\\n        <ButtonBar\\n          resize\\n          buttons={[\\n            {\\n              icon: \\"link\\",\\n              onclick: () => openPopup(Help, \\"Help\\"),\\n              tooltip: $isChangelogVersionCurrent ? \\"help\\" : \\"new updates\\",\\n              tutorialHighlight: 1,\\n              notification: !$isChangelogVersionCurrent,\\n            },\\n            {\\n              icon: \\"gear\\",\\n              onclick: () => openPopup(Settings, \\"Settings\\"),\\n              tooltip: \\"settings\\",\\n              tutorialHighlight: 2,\\n            },\\n            {\\n              icon: \\"file\\",\\n              onclick: () => openPopup(DownloadUpload, \\"File\\"),\\n              tooltip: \\"file\\",\\n              tutorialHighlight: 3,\\n            },\\n            {\\n              icon: \\"people\\",\\n              onclick: () =>\\n                $isLoggedIn\\n                  ? openPopup(ShareFlow, \\"Share Flow\\")\\n                  : openPopup(Share, \\"Share\\"),\\n              tooltip: \\"share\\",\\n              tutorialHighlight: 4,\\n            },\\n          ]}\\n        />\\n        {#if $isLoggedIn}\\n          <div class=\\"cloud-status\\">\\n            <span\\n              class=\\"save-indicator\\"\\n              class:saved={$saveStatus === \\"saved\\"}\\n              class:saving={$saveStatus === \\"saving\\"}\\n              class:error={$saveStatus === \\"error\\"}\\n            >\\n              {#if $saveStatus === \\"saving\\"}Saving...{:else if $saveStatus === \\"saved\\"}Saved\\n                ✓{:else if $saveStatus === \\"error\\"}Save error{:else}&nbsp;{/if}\\n            </span>\\n          </div>\\n        {/if}\\n      </div>\\n      <div\\n        class=\\"tabs\\"\\n        class:customScrollbar={settings.data.customScrollbar.value}\\n      >\\n        <div class=\\"tabScroll\\">\\n          {#if $isLoggedIn && $cloudFlowList.length > 0}\\n            <div class=\\"cloud-flows-section\\">\\n              <div class=\\"section-label\\">Your Flows</div>\\n              {#each $cloudFlowList as flow}\\n                <div class=\\"cloud-flow-item-wrapper\\">\\n                  {#if editingFlowId === flow.id}\\n                    <input\\n                      id=\\"cloud-flow-edit-input\\"\\n                      class=\\"cloud-flow-edit-input\\"\\n                      bind:value={editingFlowTitle}\\n                      on:blur={finishEditingFlow}\\n                      on:keydown={(e) => {\\n                        if (e.key === \\"Enter\\") finishEditingFlow();\\n                        if (e.key === \\"Escape\\") {\\n                          editingFlowId = null;\\n                        }\\n                      }}\\n                    />\\n                  {:else}\\n                    <button\\n                      class=\\"cloud-flow-item\\"\\n                      class:active={$currentCloudFlowId === flow.id}\\n                      class:shared={flow.is_shared}\\n                      on:click={() => openCloudFlow(flow.id)}\\n                    >\\n                      <span class=\\"flow-title\\">{flow.title || \\"Untitled\\"}</span>\\n                      {#if flow.is_shared}\\n                        <span class=\\"shared-badge\\">shared</span>\\n                      {/if}\\n                    </button>\\n                  {/if}\\n                  <button\\n                    class=\\"cloud-flow-action cloud-flow-edit\\"\\n                    on:click|stopPropagation={() =>\\n                      startEditingFlow(flow.id, flow.title)}\\n                    title=\\"Rename flow\\"\\n                  >\\n                    ✎\\n                  </button>\\n                  <button\\n                    class=\\"cloud-flow-action cloud-flow-delete\\"\\n                    on:click|stopPropagation={() =>\\n                      handleDeleteCloudFlow(flow.id, flow.title)}\\n                    title=\\"Delete flow\\"\\n                  >\\n                    ×\\n                  </button>\\n                </div>\\n              {/each}\\n            </div>\\n            <button\\n              class=\\"new-flow-btn\\"\\n              on:click={() => {\\n                startNewCloudFlow();\\n                replaceNodes(newNodes());\\n                $selectedFlowId = null;\\n              }}\\n            >\\n              + New Flow\\n            </button>\\n            <div class=\\"section-divider\\" />\\n            <div class=\\"section-label\\">Current Flow Tabs</div>\\n          {/if}\\n          <SortableList\\n            list={$nodes.root.children}\\n            on:sort={handleSort}\\n            let:index\\n          >\\n            <Tab\\n              on:click={() => clickTab($nodes.root.children[index])}\\n              flowId={$nodes.root.children[index]}\\n              selected={$selectedFlowId == $nodes.root.children[index]}\\n            />\\n          </SortableList>\\n          <AddTab {addFlow} bind:switchSpeakers />\\n        </div>\\n      </div>\\n      <div class=\\"sidebar-footer\\">\\n        {#if $isLoggedIn}\\n          <button\\n            class=\\"sidebar-action-btn share-btn\\"\\n            on:click={() => openPopup(ShareFlow, \\"Share Flow\\")}\\n            disabled={!$currentCloudFlowId}\\n          >\\n            Share Flow\\n          </button>\\n          <button class=\\"sidebar-action-btn signout-btn\\" on:click={signOut}>\\n            Sign Out\\n          </button>\\n        {/if}\\n      </div>\\n      <div class=\\"timer\\">\\n        <Timers />\\n      </div>\\n    </div>\\n    {#if $authLoading}\\n      <div class=\\"prelude\\">\\n        <div class=\\"loading-message\\">Loading...</div>\\n      </div>\\n    {:else if !$isLoggedIn}\\n      <div class=\\"prelude\\">\\n        <Auth />\\n      </div>\\n    {:else if $nodes.root.children.length > 0}\\n      {#if $selectedFlowId != null && $nodes[$selectedFlowId]}\\n        {#key $selectedFlowId}\\n          <div class=\\"title\\">\\n            <Title\\n              flowId={$selectedFlowId}\\n              deleteSelf={() => deleteFlowAndFocus()}\\n            />\\n          </div>\\n          <div class=\\"box-control\\">\\n            <BoxControl flowId={$selectedFlowId} />\\n          </div>\\n          {#if otherViewers.length > 0}\\n            <div class=\\"presence-strip\\">\\n              {#each otherViewers as viewer}\\n                <div\\n                  class=\\"viewer-avatar\\"\\n                  style=\\"background: {getAvatarColor(viewer.user_id)}\\"\\n                  title=\\"{viewer.display_name} is editing\\"\\n                >\\n                  {getInitials(viewer.display_name)}\\n                </div>\\n              {/each}\\n            </div>\\n          {/if}\\n          <div\\n            class=\\"flow\\"\\n            class:customScrollbar={settings.data.customScrollbar.value}\\n            on:scroll={fixScroll}\\n          >\\n            <Flow on:focusFlow={focusFlow} flowId={$selectedFlowId} />\\n          </div>\\n        {/key}\\n      {/if}\\n      {#if showSideDoc}\\n        <div class=\\"side-doc\\">\\n          <SideDoc />\\n        </div>\\n      {/if}\\n    {:else}\\n      <div class=\\"prelude\\">\\n        <Prelude />\\n      </div>\\n    {/if}\\n  </div>\\n</main>\\n\\n<style>\\n  :global(body.app) {\\n    overflow-x: auto;\\n    overflow-y: clip;\\n  }\\n  .grid {\\n    display: grid;\\n    gap: var(--gap);\\n    grid-template-areas:\\n      \\"sidebar title box-control presence\\"\\n      \\"sidebar flow flow flow\\";\\n    grid-template-columns: var(--sidebar-width) 1fr auto auto;\\n    padding: var(--main-margin);\\n    width: 100%;\\n    height: 100%;\\n    box-sizing: border-box;\\n    position: relative;\\n  }\\n  .grid:has(.side-doc) {\\n    grid-template-areas:\\n      \\"sidebar title box-control presence side-doc\\"\\n      \\"sidebar flow flow flow side-doc\\";\\n    grid-template-columns: var(--sidebar-width) 1fr auto auto auto;\\n  }\\n  .grid.showPrelude {\\n    grid-template-areas: \\"sidebar prelude\\";\\n    grid-template-columns: var(--sidebar-width) auto;\\n  }\\n\\n  .sidebar {\\n    background: var(--background);\\n    width: 100%;\\n    height: var(--main-height);\\n    border-radius: var(--border-radius);\\n    padding: var(--padding);\\n    grid-area: sidebar;\\n    display: flex;\\n    flex-direction: column;\\n    box-sizing: border-box;\\n  }\\n  .header {\\n    height: auto;\\n    padding-bottom: var(--padding);\\n  }\\n  .tabs {\\n    overflow-y: auto;\\n    height: var(--main-height);\\n    box-sizing: border-box;\\n    position: relative;\\n  }\\n  .tabScroll {\\n    padding: 0;\\n    margin: 0;\\n    padding-top: 0;\\n    padding-bottom: calc(var(--view-height) * 0.6);\\n  }\\n\\n  .title {\\n    background: var(--background);\\n    border-radius: var(--border-radius);\\n    width: 100%;\\n    grid-area: title;\\n    height: var(--title-height);\\n  }\\n  .box-control {\\n    background: var(--background);\\n    border-radius: var(--border-radius);\\n    width: 100%;\\n    grid-area: box-control;\\n    height: var(--title-height);\\n  }\\n  .flow {\\n    width: 100%;\\n    overflow-x: auto;\\n    overflow-y: clip;\\n    background: var(--background);\\n    z-index: 0;\\n    border-radius: var(--border-radius);\\n    grid-area: flow;\\n    height: var(--view-height);\\n  }\\n  .prelude {\\n    position: relative;\\n    width: calc(100vw - var(--sidebar-width) - var(--gap) * 3);\\n    height: var(--main-height);\\n    grid-area: prelude;\\n  }\\n  .side-doc {\\n    position: relative;\\n    width: var(--side-doc-width);\\n    height: var(--main-height);\\n    grid-area: side-doc;\\n  }\\n\\n  /* ─── Cloud flow list & sidebar additions ─── */\\n  .cloud-status {\\n    padding: 0.25rem 0;\\n    text-align: center;\\n  }\\n  .save-indicator {\\n    font-size: 0.75rem;\\n    opacity: 0.5;\\n    transition: opacity 0.3s ease;\\n  }\\n  .save-indicator.saving {\\n    opacity: 0.8;\\n  }\\n  .save-indicator.saved {\\n    opacity: 0.7;\\n    color: hsl(120, 40%, 55%);\\n  }\\n  .save-indicator.error {\\n    opacity: 1;\\n    color: hsl(0, 60%, 55%);\\n  }\\n  .cloud-flows-section {\\n    display: flex;\\n    flex-direction: column;\\n    gap: 2px;\\n    margin-bottom: 0.25rem;\\n  }\\n  .section-label {\\n    font-size: 0.7rem;\\n    text-transform: uppercase;\\n    letter-spacing: 0.05em;\\n    opacity: 0.5;\\n    padding: 0.35rem 0.5rem 0.15rem;\\n    font-weight: var(--font-weight-bold);\\n  }\\n  .section-divider {\\n    height: 1px;\\n    background: currentColor;\\n    opacity: 0.1;\\n    margin: 0.5rem 0;\\n  }\\n  .cloud-flow-item-wrapper {\\n    display: flex;\\n    align-items: center;\\n    gap: 0;\\n    position: relative;\\n  }\\n\\n  .cloud-flow-edit-input {\\n    flex: 1;\\n    padding: 0.35rem 0.5rem;\\n    border: 1px solid var(--accent-text);\\n    border-radius: calc(var(--border-radius) * 0.4);\\n    background: var(--background-accent-indent);\\n    color: inherit;\\n    font-family: inherit;\\n    font-size: 0.85rem;\\n    outline: none;\\n  }\\n  .cloud-flow-action {\\n    background: none;\\n    border: none;\\n    color: inherit;\\n    font-size: 1rem;\\n    cursor: pointer;\\n    padding: 0.15rem 0.3rem;\\n    opacity: 0;\\n    transition: opacity var(--transition-speed) ease;\\n    flex-shrink: 0;\\n    line-height: 1;\\n  }\\n  .cloud-flow-item-wrapper:hover .cloud-flow-action {\\n    opacity: 0.45;\\n  }\\n  .cloud-flow-action:hover {\\n    opacity: 1 !important;\\n  }\\n  .cloud-flow-delete:hover {\\n    color: hsl(0, 60%, 55%);\\n  }\\n  .cloud-flow-edit:hover {\\n    color: var(--accent-text);\\n  }\\n  .cloud-flow-item {\\n    display: flex;\\n    align-items: center;\\n    justify-content: space-between;\\n    width: 100%;\\n    padding: 0.4rem 0.5rem;\\n    border: none;\\n    border-radius: calc(var(--border-radius) * 0.4);\\n    background: transparent;\\n    color: inherit;\\n    font-family: inherit;\\n    font-size: 0.85rem;\\n    cursor: pointer;\\n    text-align: left;\\n    transition: background var(--transition-speed) ease;\\n  }\\n  .cloud-flow-item:hover {\\n    background: var(--background-accent-indent);\\n  }\\n  .cloud-flow-item.active {\\n    background: var(--background-accent-active);\\n  }\\n  .cloud-flow-item .flow-title {\\n    overflow: hidden;\\n    text-overflow: ellipsis;\\n    white-space: nowrap;\\n    flex: 1;\\n  }\\n  .shared-badge {\\n    font-size: 0.65rem;\\n    padding: 0.1rem 0.35rem;\\n    border-radius: 3px;\\n    background: hsl(210, 50%, 45%);\\n    color: white;\\n    margin-left: 0.5rem;\\n    flex-shrink: 0;\\n  }\\n  .new-flow-btn {\\n    width: 100%;\\n    padding: 0.4rem 0.5rem;\\n    border: 1px dashed currentColor;\\n    border-radius: calc(var(--border-radius) * 0.4);\\n    background: transparent;\\n    color: inherit;\\n    font-family: inherit;\\n    font-size: 0.8rem;\\n    cursor: pointer;\\n    opacity: 0.5;\\n    transition: opacity var(--transition-speed) ease;\\n  }\\n  .new-flow-btn:hover {\\n    opacity: 0.8;\\n  }\\n  .sidebar-footer {\\n    display: flex;\\n    flex-direction: column;\\n    gap: 0.35rem;\\n    padding-top: 0.5rem;\\n    margin-top: auto;\\n  }\\n  .sidebar-action-btn {\\n    width: 100%;\\n    padding: 0.45rem 0.5rem;\\n    border: none;\\n    border-radius: calc(var(--border-radius) * 0.4);\\n    font-family: inherit;\\n    font-size: 0.8rem;\\n    cursor: pointer;\\n    transition: opacity var(--transition-speed) ease;\\n  }\\n  .sidebar-action-btn:hover:not(:disabled) {\\n    opacity: 0.85;\\n  }\\n  .sidebar-action-btn:disabled {\\n    opacity: 0.35;\\n    cursor: not-allowed;\\n  }\\n  .share-btn {\\n    background: var(--accent-text);\\n    color: var(--background);\\n    font-weight: var(--font-weight-bold);\\n  }\\n  .signout-btn {\\n    background: transparent;\\n    color: inherit;\\n    opacity: 0.5;\\n    border: 1px solid currentColor;\\n  }\\n  .signout-btn:hover {\\n    opacity: 0.7 !important;\\n  }\\n  .loading-message {\\n    display: flex;\\n    align-items: center;\\n    justify-content: center;\\n    width: 100%;\\n    height: 100%;\\n    opacity: 0.5;\\n    font-size: 1.1rem;\\n  }\\n\\n  /* ─── Presence strip ─── */\\n  .presence-strip {\\n    display: flex;\\n    align-items: center;\\n    gap: -4px;\\n    padding: 0 0.5rem;\\n    height: var(--title-height);\\n    grid-area: presence;\\n  }\\n  .viewer-avatar {\\n    width: 26px;\\n    height: 26px;\\n    border-radius: 50%;\\n    display: flex;\\n    align-items: center;\\n    justify-content: center;\\n    font-size: 0.6rem;\\n    font-weight: bold;\\n    color: white;\\n    border: 2px solid var(--background);\\n    margin-left: -4px;\\n    cursor: default;\\n    flex-shrink: 0;\\n  }\\n  .viewer-avatar:first-child {\\n    margin-left: 0;\\n  }\\n</style>\\n"],"names":[],"mappings":"AA0iBU,QAAU,CAChB,UAAU,CAAE,IAAI,CAChB,UAAU,CAAE,IACd,CACA,iCAAM,CACJ,OAAO,CAAE,IAAI,CACb,GAAG,CAAE,IAAI,KAAK,CAAC,CACf,mBAAmB,CACjB;AACN,MAAM,wBAAwB,CAC1B,qBAAqB,CAAE,IAAI,eAAe,CAAC,CAAC,GAAG,CAAC,IAAI,CAAC,IAAI,CACzD,OAAO,CAAE,IAAI,aAAa,CAAC,CAC3B,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,UAAU,CACtB,QAAQ,CAAE,QACZ,CACA,iCAAK,KAAK,SAAS,CAAE,CACnB,mBAAmB,CACjB;AACN,MAAM,iCAAiC,CACnC,qBAAqB,CAAE,IAAI,eAAe,CAAC,CAAC,GAAG,CAAC,IAAI,CAAC,IAAI,CAAC,IAC5D,CACA,KAAK,wCAAa,CAChB,mBAAmB,CAAE,iBAAiB,CACtC,qBAAqB,CAAE,IAAI,eAAe,CAAC,CAAC,IAC9C,CAEA,oCAAS,CACP,UAAU,CAAE,IAAI,YAAY,CAAC,CAC7B,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,aAAa,CAAC,CAC1B,aAAa,CAAE,IAAI,eAAe,CAAC,CACnC,OAAO,CAAE,IAAI,SAAS,CAAC,CACvB,SAAS,CAAE,OAAO,CAClB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,UAAU,CAAE,UACd,CACA,mCAAQ,CACN,MAAM,CAAE,IAAI,CACZ,cAAc,CAAE,IAAI,SAAS,CAC/B,CACA,iCAAM,CACJ,UAAU,CAAE,IAAI,CAChB,MAAM,CAAE,IAAI,aAAa,CAAC,CAC1B,UAAU,CAAE,UAAU,CACtB,QAAQ,CAAE,QACZ,CACA,sCAAW,CACT,OAAO,CAAE,CAAC,CACV,MAAM,CAAE,CAAC,CACT,WAAW,CAAE,CAAC,CACd,cAAc,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,CAAC,GAAG,CAC/C,CAEA,kCAAO,CACL,UAAU,CAAE,IAAI,YAAY,CAAC,CAC7B,aAAa,CAAE,IAAI,eAAe,CAAC,CACnC,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,KAAK,CAChB,MAAM,CAAE,IAAI,cAAc,CAC5B,CACA,wCAAa,CACX,UAAU,CAAE,IAAI,YAAY,CAAC,CAC7B,aAAa,CAAE,IAAI,eAAe,CAAC,CACnC,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,WAAW,CACtB,MAAM,CAAE,IAAI,cAAc,CAC5B,CACA,iCAAM,CACJ,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,IAAI,CAChB,UAAU,CAAE,IAAI,CAChB,UAAU,CAAE,IAAI,YAAY,CAAC,CAC7B,OAAO,CAAE,CAAC,CACV,aAAa,CAAE,IAAI,eAAe,CAAC,CACnC,SAAS,CAAE,IAAI,CACf,MAAM,CAAE,IAAI,aAAa,CAC3B,CACA,oCAAS,CACP,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,KAAK,KAAK,CAAC,CAAC,CAAC,IAAI,eAAe,CAAC,CAAC,CAAC,CAAC,IAAI,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAC1D,MAAM,CAAE,IAAI,aAAa,CAAC,CAC1B,SAAS,CAAE,OACb,CACA,qCAAU,CACR,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,gBAAgB,CAAC,CAC5B,MAAM,CAAE,IAAI,aAAa,CAAC,CAC1B,SAAS,CAAE,QACb,CAGA,yCAAc,CACZ,OAAO,CAAE,OAAO,CAAC,CAAC,CAClB,UAAU,CAAE,MACd,CACA,2CAAgB,CACd,SAAS,CAAE,OAAO,CAClB,OAAO,CAAE,GAAG,CACZ,UAAU,CAAE,OAAO,CAAC,IAAI,CAAC,IAC3B,CACA,eAAe,mCAAQ,CACrB,OAAO,CAAE,GACX,CACA,eAAe,kCAAO,CACpB,OAAO,CAAE,GAAG,CACZ,KAAK,CAAE,IAAI,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAC1B,CACA,eAAe,kCAAO,CACpB,OAAO,CAAE,CAAC,CACV,KAAK,CAAE,IAAI,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CACxB,CACA,gDAAqB,CACnB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,GAAG,CAAE,GAAG,CACR,aAAa,CAAE,OACjB,CACA,0CAAe,CACb,SAAS,CAAE,MAAM,CACjB,cAAc,CAAE,SAAS,CACzB,cAAc,CAAE,MAAM,CACtB,OAAO,CAAE,GAAG,CACZ,OAAO,CAAE,OAAO,CAAC,MAAM,CAAC,OAAO,CAC/B,WAAW,CAAE,IAAI,kBAAkB,CACrC,CACA,4CAAiB,CACf,MAAM,CAAE,GAAG,CACX,UAAU,CAAE,YAAY,CACxB,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,MAAM,CAAC,CACjB,CACA,oDAAyB,CACvB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,GAAG,CAAE,CAAC,CACN,QAAQ,CAAE,QACZ,CAEA,kDAAuB,CACrB,IAAI,CAAE,CAAC,CACP,OAAO,CAAE,OAAO,CAAC,MAAM,CACvB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,aAAa,CAAC,CACpC,aAAa,CAAE,KAAK,IAAI,eAAe,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAC/C,UAAU,CAAE,IAAI,0BAA0B,CAAC,CAC3C,KAAK,CAAE,OAAO,CACd,WAAW,CAAE,OAAO,CACpB,SAAS,CAAE,OAAO,CAClB,OAAO,CAAE,IACX,CACA,8CAAmB,CACjB,UAAU,CAAE,IAAI,CAChB,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,OAAO,CACd,SAAS,CAAE,IAAI,CACf,MAAM,CAAE,OAAO,CACf,OAAO,CAAE,OAAO,CAAC,MAAM,CACvB,OAAO,CAAE,CAAC,CACV,UAAU,CAAE,OAAO,CAAC,IAAI,kBAAkB,CAAC,CAAC,IAAI,CAChD,WAAW,CAAE,CAAC,CACd,WAAW,CAAE,CACf,CACA,sCAAwB,MAAM,CAAC,gCAAmB,CAChD,OAAO,CAAE,IACX,CACA,8CAAkB,MAAO,CACvB,OAAO,CAAE,CAAC,CAAC,UACb,CACA,8CAAkB,MAAO,CACvB,KAAK,CAAE,IAAI,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CACxB,CACA,4CAAgB,MAAO,CACrB,KAAK,CAAE,IAAI,aAAa,CAC1B,CACA,4CAAiB,CACf,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,aAAa,CAC9B,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,MAAM,CAAC,MAAM,CACtB,MAAM,CAAE,IAAI,CACZ,aAAa,CAAE,KAAK,IAAI,eAAe,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAC/C,UAAU,CAAE,WAAW,CACvB,KAAK,CAAE,OAAO,CACd,WAAW,CAAE,OAAO,CACpB,SAAS,CAAE,OAAO,CAClB,MAAM,CAAE,OAAO,CACf,UAAU,CAAE,IAAI,CAChB,UAAU,CAAE,UAAU,CAAC,IAAI,kBAAkB,CAAC,CAAC,IACjD,CACA,4CAAgB,MAAO,CACrB,UAAU,CAAE,IAAI,0BAA0B,CAC5C,CACA,gBAAgB,mCAAQ,CACtB,UAAU,CAAE,IAAI,0BAA0B,CAC5C,CACA,8BAAgB,CAAC,yBAAY,CAC3B,QAAQ,CAAE,MAAM,CAChB,aAAa,CAAE,QAAQ,CACvB,WAAW,CAAE,MAAM,CACnB,IAAI,CAAE,CACR,CACA,yCAAc,CACZ,SAAS,CAAE,OAAO,CAClB,OAAO,CAAE,MAAM,CAAC,OAAO,CACvB,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,IAAI,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAC9B,KAAK,CAAE,KAAK,CACZ,WAAW,CAAE,MAAM,CACnB,WAAW,CAAE,CACf,CACA,yCAAc,CACZ,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,MAAM,CAAC,MAAM,CACtB,MAAM,CAAE,GAAG,CAAC,MAAM,CAAC,YAAY,CAC/B,aAAa,CAAE,KAAK,IAAI,eAAe,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAC/C,UAAU,CAAE,WAAW,CACvB,KAAK,CAAE,OAAO,CACd,WAAW,CAAE,OAAO,CACpB,SAAS,CAAE,MAAM,CACjB,MAAM,CAAE,OAAO,CACf,OAAO,CAAE,GAAG,CACZ,UAAU,CAAE,OAAO,CAAC,IAAI,kBAAkB,CAAC,CAAC,IAC9C,CACA,yCAAa,MAAO,CAClB,OAAO,CAAE,GACX,CACA,2CAAgB,CACd,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,GAAG,CAAE,OAAO,CACZ,WAAW,CAAE,MAAM,CACnB,UAAU,CAAE,IACd,CACA,+CAAoB,CAClB,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,OAAO,CAAC,MAAM,CACvB,MAAM,CAAE,IAAI,CACZ,aAAa,CAAE,KAAK,IAAI,eAAe,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAC/C,WAAW,CAAE,OAAO,CACpB,SAAS,CAAE,MAAM,CACjB,MAAM,CAAE,OAAO,CACf,UAAU,CAAE,OAAO,CAAC,IAAI,kBAAkB,CAAC,CAAC,IAC9C,CACA,+CAAmB,MAAM,KAAK,SAAS,CAAE,CACvC,OAAO,CAAE,IACX,CACA,+CAAmB,SAAU,CAC3B,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,WACV,CACA,sCAAW,CACT,UAAU,CAAE,IAAI,aAAa,CAAC,CAC9B,KAAK,CAAE,IAAI,YAAY,CAAC,CACxB,WAAW,CAAE,IAAI,kBAAkB,CACrC,CACA,wCAAa,CACX,UAAU,CAAE,WAAW,CACvB,KAAK,CAAE,OAAO,CACd,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,YACpB,CACA,wCAAY,MAAO,CACjB,OAAO,CAAE,GAAG,CAAC,UACf,CACA,4CAAiB,CACf,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,CACvB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,GAAG,CACZ,SAAS,CAAE,MACb,CAGA,2CAAgB,CACd,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,GAAG,CAAE,IAAI,CACT,OAAO,CAAE,CAAC,CAAC,MAAM,CACjB,MAAM,CAAE,IAAI,cAAc,CAAC,CAC3B,SAAS,CAAE,QACb,CACA,0CAAe,CACb,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,aAAa,CAAE,GAAG,CAClB,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,CACvB,SAAS,CAAE,MAAM,CACjB,WAAW,CAAE,IAAI,CACjB,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,YAAY,CAAC,CACnC,WAAW,CAAE,IAAI,CACjB,MAAM,CAAE,OAAO,CACf,WAAW,CAAE,CACf,CACA,0CAAc,YAAa,CACzB,WAAW,CAAE,CACf"}'
};
function getInitials(name) {
  return name.split(" ").map((w) => w[0]).join("").toUpperCase().slice(0, 2) || "?";
}
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = ` <main class="${["palette-plain", activeMouse ? "activeMouse" : ""].join(" ").trim()}"><input id="uploadId" type="file" hidden> <div class="${[
    ...
    ].join(" ").trim()}"><div class="sidebar svelte-k3vrvb"><div class="header svelte-k3vrvb">${validate_component(ButtonBar, "ButtonBar").$$render(
      $$result,
      {
        resize: true,
        buttons: [
          ...
          {
            icon: "people",
            onclick: () => $isLoggedIn ? openPopup(ShareFlow, "Share Flow") : openPopup(Share, "Share"),
            tooltip: "share",
            tutorialHighlight: 4
          }
        ]
      ...
      {},
      {}
    )} ${$isLoggedIn ? `<div class="cloud-status svelte-k3vrvb"><span class="${[
      "save-indicator svelte-k3vrvb",
      ($saveStatus === "saved" ? "saved" : "") + " " + ($saveStatus === "saving" ? "saving" : "") + " " + ($saveStatus === "error" ? "error" : "")
    ].join(" ").trim()}">${$saveStatus === "saving" ? `Saving...` : `${$saveStatus === "saved" ? `Saved
                ✓` : `${$saveStatus === "error" ? `Save error` : ` `}`}`}</span></div>` : ``}</div> <div class="${[
      "tabs svelte-k3vrvb",
      settings.data.customScrollbar.value ? "customScrollbar" : ""
    ].join(" ").trim()}"><div class="tabScroll svelte-k3vrvb">${$isLoggedIn && $cloudFlowList.length > 0 ? `<div class="cloud-flows-section svelte-k3vrvb"><div class="section-label svelte-k3vrvb" data-svelte-h="svelte-1g1s9en">Your Flows</div> ${each($cloudFlowList, (flow) => {
      return `<div class="cloud-flow-item-wrapper svelte-k3vrvb">${editingFlowId === flow.id ? `<input id="cloud-flow-edit-input" class="cloud-flow-edit-input svelte-k3vrvb"${add_attribute("value", editingFlowTitle, 0)}>` : `<button class="${[
        "cloud-flow-item svelte-k3vrvb",
        ($currentCloudFlowId === flow.id ? "active" : "") + " " + (flow.is_shared ? "shared" : "")
      ].join(" ").trim()}"><span class="flow-title svelte-k3vrvb">${escape(flow.title || "Untitled")}</span> ${flow.is_shared ? `<span class="shared-badge svelte-k3vrvb" data-svelte-h="svelte-ox5vk7">shared</span>` : ``} </button>`} <button class="cloud-flow-action cloud-flow-edit svelte-k3vrvb" title="Rename flow" data-svelte-h="svelte-132yx58">✎</button> <button class="cloud-flow-action cloud-flow-delete svelte-k3vrvb" title="Delete flow" data-svelte-h="svelte-fzv197">×</button> </div>`;
    })}</div> <button class="new-flow-btn svelte-k3vrvb" data-svelte-h="svelte-1j1xl8p">+ New Flow</button> <div class="section-divider svelte-k3vrvb"></div> <div class="section-label svelte-k3vrvb" data-svelte-h="svelte-15dxj9u">Current Flow Tabs</div>` : ``} ${validate_component(SortableList, "SortableList").$$render($$result, { list: $nodes.root.children }, {}, {
      default: ({ index }) => {
      ...
      {}
    )}</div></div> <div class="sidebar-footer svelte-k3vrvb">${$isLoggedIn ? `<button class="sidebar-action-btn share-btn svelte-k3vrvb" ${!$currentCloudFlowId ? "disabled" : ""}>Share Flow</button> <button class="sidebar-action-btn signout-btn svelte-k3vrvb" data-svelte-h="svelte-16upgnz">Sign Out</button>` : ``}</div> <div class="timer">${validate_component(Timers, "Timers").$$render($$result, {}, {}, {})}</div></div> ${$authLoading ? `<div class="prelude svelte-k3vrvb" data-svelte-h="svelte-1ei1ena"><div class="loading-message svelte-k3vrvb">Loading...</div></div>` : `${!$isLoggedIn ? `<div class="prelude svelte-k3vrvb">${validate_component(Auth, "Auth").$$render($$result, {}, {}, {})}</div>` : `${$nodes.root.children.length > 0 ? `${$selectedFlowId != null && $nodes[$selectedFlowId] ? `<div class="title svelte-k3vrvb">${validate_component(Title, "Title").$$render(
      $$result,
      {
        flowId: $selectedFlowId,
        deleteSelf: () => deleteFlowAndFocus()
      ...
      {},
      {}
    )}</div> <div class="box-control svelte-k3vrvb">${validate_component(BoxControl, "BoxControl").$$render($$result, { flowId: $selectedFlowId }, {}, {})}</div> ${otherViewers.length > 0 ? `<div class="presence-strip svelte-k3vrvb">${each(otherViewers, (viewer) => {
      return `<div class="viewer-avatar svelte-k3vrvb" style="${"background: " + escape(getAvatarColor(viewer.user_id), true)}" title="${escape(viewer.display_name, true) + " is editing"}">${escape(getInitials(viewer.display_name))} </div>`;
    })}</div>` : ``} <div class="${[
      "flow svelte-k3vrvb",
      settings.data.customScrollbar.value ? "customScrollbar" : ""
    ].join(" ").trim()}">${validate_component(Flow, "Flow").$$render($$result, { flowId: $selectedFlowId }, {}, {})}</div>` : ``} ${showSideDoc ? `<div class="side-doc svelte-k3vrvb">${validate_component(SideDoc, "SideDoc").$$render($$result, {}, {}, {})}</div>` : ``}` : `<div class="prelude svelte-k3vrvb">${validate_component(Prelude, "Prelude").$$render($$result, {}, {}, {})}</div>`}`}`}</div> </main>`;
  } while (!$$settled);
  $$unsubscribe_selectedFlowId();
  $$unsubscribe_activeMouse();
  $$unsubscribe_nodes();
