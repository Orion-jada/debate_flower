// @ts-check
/**
 * @typedef {{ message: 'flower:init' }} SheetsInitMessage
 * @typedef {{ message: 'flower:close' }} SheetsCloseMessage
 * @typedef {{ message: 'flower:readCell', data: {col: number, row: number}[] }} SheetsReadCellMessage
 * @typedef {{ message: 'flower:writeCell', data: {col: number, row: number, value: string}[] }} SheetsWriteCellMessage
 * @typedef {{ message: 'flower:resizeMove', data: {width?: string, height?: string, top?: string, left?: string} }} SheetsResizeMoveMessage
 * @typedef {SheetsInitMessage | SheetsCloseMessage | SheetsReadCellMessage | SheetsWriteCellMessage | SheetsResizeMoveMessage} SheetsMessage
 *
 * @typedef {{ message: 'flower:init', data: {version: string, ready: boolean, url: string} }} SheetsInitResponse
 * @typedef {{ message: 'flower:readCell', data: {value: string}[] }} SheetsReadCellResponse
 * @typedef {{ message: 'flower:writeCell', data: null }} SheetsWriteCellResponse
 * @typedef {{ message: 'flower:resizeMove', data: null }} SheetsResizeMoveResponse
 * @typedef {SheetsInitResponse | SheetsReadCellResponse | SheetsWriteCellResponse | SheetsResizeMoveResponse} SheetsResponse
 */
